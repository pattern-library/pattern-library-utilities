 ...
 * @return {Object} An instance of Winston.
 */
exports.logger = function (projectOptions) {
  'use strict';

  var options = utility.getOptions(getDefaultOptions(), projectOptions);

  var exitOnError = options.logger.exitOnError;
  var level = options.logger.level;
  var logFile = options.logger.logFile;
  var silent = options.logger.silent;
  var transports = [
